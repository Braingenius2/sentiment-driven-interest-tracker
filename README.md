...
**Promo video:** `app/media/tutor_promo.mp4` (33s, generated by `app/media/make_promo.py`)
**Live tracker:** Module 6 refreshes `tracker/data/` weekly via `.github/workflows/update_tracker.yml` — the frozen capstone files never change.
